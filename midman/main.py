...
def main():
    CliBuilder('middleman', run=setup_proxy, help_on_empty=True, version=__version__,
        ...
        parameter('replay_throttle', help='throttle response if too many requests are made', type=boolean, default=False),
        parameter('replay_clear_cache', help='enable clearing cache periodically', type=boolean, default=True),
